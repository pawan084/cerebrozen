...
export const Icon: Record<string, () => JSX.Element> = {
  ...
  // The tab bar renders Icon[t.key] — every Tab key MUST have a glyph, or the
  // whole dashboard dies on first paint (React #130; the "media" tab shipped
  // without one and took down every admin screen).
  media: () => s(<><rect x="3" y="5" width="18" height="14" rx="2" /><path d="M10 9.2l5.2 2.8-5.2 2.8z" /></>),
