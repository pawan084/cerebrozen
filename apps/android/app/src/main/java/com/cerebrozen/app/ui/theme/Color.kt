...
//   Primary   Coral (zen-500) #F56B6B   (CereBroZen brand, design/tokens.css)
...
internal object NightPalette {
    ...
    // Accents AS TEXT on navy. Coral is lifted #F56B6B → #F58A8A (zen-400): the
    // brand hue itself is a fill; the text tier clears AA on every surface.
    val periwinkle = Color(0xFFF58A8A)  //  ~7.0 on bg · ~5.4 on raised
    ...
    val navSelectedHi = Color(0xB8D94F4F)      // zen-700 @72% (light label stays AA)
    val navSelectedLo = Color(0x2ED94F4F)      // zen-700 @18%
...
internal object DawnPalette {
    ...
    val periwinkle = Color(0xFFB03A3A)  //  ~5.1 on worst ground · ~6.0 on card
    ...
    val navSelectedHi = Color(0x4DF56B6B)
    val navSelectedLo = Color(0x14F56B6B)
...
val BrandPrimary = Color(0xFFF56B6B)    // Coral — zen-500, the CereBroZen accent
...
val LavenderPillTop = Color(0xFFC64444)
val LavenderPillFloor = Color(0xFFB03A3A)
...
val PeriwinkleSoft = Color(0xFFFCD9D4)   // soft coral wash (zen-100) / on-art eyebrow
val Iris = Color(0xFFF58A8A)
val Violet = Color(0xFFD94F4F)
...
val WelcomeOrbEdge = Color(0xFFF5A9A9)
val PrimaryButtonFill = Color(0xFFC64444)
...
val AuthEyebrow = Color(0xFFF58A8A)
