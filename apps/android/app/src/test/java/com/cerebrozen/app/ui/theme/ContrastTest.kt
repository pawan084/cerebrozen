...
class ContrastTest {
    ...
    fun brandFills_matchTheOwnerSpecification_exactly() {
        // The brand colours ship verbatim as fills. If a future pass "fixes"
        // their contrast by changing them, the brand changes — fail loudly instead.
        // CereBroZen rebrand (2026-07-14): primary is coral zen-500 (design/tokens.css).
        assertEquals("BrandPrimary", Color(0xFFF56B6B).toArgb(), BrandPrimary.toArgb())
