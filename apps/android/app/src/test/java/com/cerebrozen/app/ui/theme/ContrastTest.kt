...
class ContrastTest {
    ...
    fun dawnPalette_pinsTheCanonicalLightValues() = dawn {
        ...
        val expected = mapOf(
            "Night" to (Night to Color(0xFFF8F4EE)),
            "NightMid" to (NightMid to Color(0xFFF3ECF3)),
            "NightPurple" to (NightPurple to Color(0xFFF3ECF3)),
            "CardFill" to (CardFill to Color(0xFFFFFCF8)),
            "FieldFill" to (FieldFill to Color(0xFFF3ECF3)),
            "ChipFill" to (ChipFill to Color(0xFFF3ECF3)),
            "LineStroke" to (LineStroke to Color(0xFFDFD9D3)),
            "TextPrimary" to (TextPrimary to Color(0xFF211D20)),
            "TextSoft" to (TextSoft to Color(0xFF514A50)),
            "TextMuted" to (TextMuted to Color(0xFF686267)),
            "TextMuted2" to (TextMuted2 to Color(0xFF686267)),
            "EyebrowMuted" to (EyebrowMuted to Color(0xFF686267)),
            "Periwinkle" to (Periwinkle to Color(0xFF5A2B5C)),
            "Accent2" to (Accent2 to Color(0xFF8A4A78)),
            "AccentSoft" to (AccentSoft to Color(0xFFE9DDEA)),
            "OnAccent" to (OnAccent to Color(0xFFFFFCF8)),
            "Ok" to (Ok to Color(0xFF49634F)),
            "OkSoft" to (OkSoft to Color(0xFFE5EDE3)),
            "Warm" to (Warm to Color(0xFFA45161)),
            "WarmSoft" to (WarmSoft to Color(0xFFFAE9EA)),
            "Danger" to (Danger to Color(0xFFC23A33)),
            "DangerSoft" to (DangerSoft to Color(0xFFFFE9E6)),
            "Amber" to (Amber to Color(0xFF92611D)),
            "AmberSoft" to (AmberSoft to Color(0xFFFFF1D8)),
            "Cyan" to (Cyan to Color(0xFF315C7A)),
