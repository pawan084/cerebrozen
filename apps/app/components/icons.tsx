...
export const Icon = {
  ...
  heart: ({ size = 20, className }: P) => svg(size, className, <path d="M12 20s-7-4.6-9.2-9A5.2 5.2 0 0112 6.4 5.2 5.2 0 0121.2 11c-2.2 4.4-9.2 9-9.2 9z" />),
  ...
  // Support door — a held heart, not an alarm (crisis surfaces stay calm).
  support: ({ size = 20, className }: P) => svg(size, className, <path d="M12 20.2S4.6 15.6 4.6 10.6A3.9 3.9 0 0112 8.3a3.9 3.9 0 017.4 2.3c0 5-7.4 9.6-7.4 9.6z" />),
};
