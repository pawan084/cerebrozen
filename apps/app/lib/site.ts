/* The marketing site (cerebrozen.in). This app is a separate deployment on its own
   subdomain, so links back to it are real navigations, not routes — never next/link.
