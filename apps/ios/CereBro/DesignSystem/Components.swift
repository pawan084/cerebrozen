...
struct Photo: View {
    ...
    var body: some View {
        AsyncImage(url: URL(string: url)) { phase in
            ...
            default:
                ZStack {
                    // Constant-dark in both themes: this stands in for a photo,
                    // and a photo does not become a light photo when the app
                    // does (same rule the web app's Wave E pinned heroes to).
                    LinearGradient(
