// The one place the landing site renders crisis numbers, so "Tele-MANAS first,
// every number tappable" cannot drift between /support and any future surface.
// Mirrors apps/app/components/CrisisLines.tsx deliberately — same markup, same
// class names, same aria wording, so a fix to one reads as a fix to the other.
//
// No hooks and no fetches: it renders in a server component, with a dead API,
// and offline. That is the point of a crisis surface.
