...
| **"You showed up on %d days this month"** (You → Your month) | `presenceMonth` marks the days a check-in landed and says nothing about the others — two check-ins on one day light one dot. No streak, no percentage, no reset | `CompanionFirstTest::presence month counts days shown up and nothing else` |
