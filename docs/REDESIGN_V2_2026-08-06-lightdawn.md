> **ARCHIVED 2026-08-15.** This is the 2026-08-06 Light-Dawn spec, recovered from git
> after the filename was reused (and its content overwritten, initially unnoticed) by the
> new compact redesign — see [REDESIGN_V2.md](REDESIGN_V2.md), which now governs. Two of
> this file's rulings are explicitly REVERSED by the 2026-08-15 owner approval: the
> five-tab set (§6.1 — Sleep is a tab again, Explore retired) and the ten-step ONB
> numbering (now four counted steps). Code/test comments citing "REDESIGN_V2 §6.1 /
> §3.1 / ONB-xx" refer to THIS archived document.
